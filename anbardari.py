...
class Pregistration(Tk) :
    ...
    def Product_registration(self) :
        ...
        self.Product_registration_delet = Button(self,bg = "#495057" , text = "حذف",font = ('B Koodak' , 14),width=15 ,relief="flat" , fg = "#FFFFFF") 
        self.Product_registration_exit = Button(self,bg = "#495057" , text = "صفحه اصلی",font = ('B Koodak' , 14),width=17 ,relief="flat" , fg = "#FFFFFF") 
        self.Product_registration_submit.place(x=50, y=775)
        self.Product_registration_edit.place(x=250, y=775)    
        self.Product_registration_delet.place(x=450, y=775)    
        self.Product_registration_exit.place(x=1140, y=775)    
        ...
        ttk.Style().configure("Treeview.Heading",font=('Lalezar', 18),
        ...
        ttk.Style().configure("Treeview", highlightthickness=0, 
                            height=150,
    ...
    def delete(self, event = None) :
        ...
        def sql_delete(name):
            command = ' DELETE FROM emp WHERE name="{}" '.format(name)    
            cur.execute(command)    
            con.commit()
